...
const Login = () => {
  ...
  const handleButtonClick = () => {
    let nameValue = "";
    if (name.current !== null) nameValue = name.current.value;
    //Validation function
  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-full md:w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-80 rounded-sm"
      >
